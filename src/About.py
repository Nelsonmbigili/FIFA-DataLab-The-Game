...
with st.spinner('Loading page...'):
    ...
    st.subheader(":violet[Predicting Football Players' Salaries and Market Values]")
    ...
    st.code('''
        ...
        "Joined(yr)", "Contract Valid Until", "Height(Feet)", "Weight(Pounds)", "Crossing", "Finishing", 
    ...
    st.write("- Use a linear regression model to predict player salaries and market values.")
    st.write("By integrating data analytics and linear regression, we aim to make FIFA player analysis accessible to everyone, from casual gamers to data science enthusiasts.")
